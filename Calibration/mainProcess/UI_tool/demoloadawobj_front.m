...
fig=figure('Name', 'Mesh front'); % open a new figure
modelname='elliptical_mesh_rectcutout_front.obj';
[v_front,F3_front]=loadawobj('elliptical_mesh_rectcutout_front.obj');
assignin('base', 'v_front', v_front);
assignin('base', 'F3_front', F3_front);
ph_front = patch('Vertices',v_front','Faces',F3_front', 'FaceColor', 'g');
assignin('base', 'ph_front', ph_front);
view(60,0);
axis('equal');
snapnow
pause(1)
