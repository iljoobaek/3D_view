...
fig=figure('Name', 'Mesh right'); % open a new figure
modelname='elliptical_mesh_rectcutout_right.obj';
[v_right,F3_right]=loadawobj('elliptical_mesh_side_flat_rectcutout_right.obj');
assignin('base', 'v_right', v_right);
assignin('base', 'F3_right', F3_right);
ph_right = patch('Vertices',v_right','Faces',F3_right', 'FaceColor', 'g');
assignin('base', 'ph_right', ph_right);
view(60,0);
axis('equal');
snapnow
pause(1)
