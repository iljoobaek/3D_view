x_mesh_back_u = [-1.667, -2.593, -1.667];
y_mesh_back_u = [-2.681, 0, 2.681];
...
x_mesh_back_b = [-0.6193, -0.6193, -0.6193, -0.6193, -0.6193, -0.6193, -0.6193, -0.6193, -0.6193, -0.6193];
y_mesh_back_b = [0.7014, 0.4826, 0.3042, 0.1474, 0, -0.1474, -0.3042, -0.4826, -0.7014, -0.9962];
...
x_mid = [-1.703, -1.925, -2.089, -2.189, -2.223, -2.189, -2.089, -1.925, -1.703];
y_mid = [-1.928, -1.5, -1.026, -0.5209, 0, 0.5209, 1.026, 1.5, 1.928];
...
x_bar_back = zeros(3963, 1);
y_bar_back = zeros(3963, 1);
...
x_bar_new_norm = abs(x_bar_back)./1280;
y_bar_new_norm = abs(1 - (y_bar_back)./720);
