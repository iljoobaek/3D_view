x_mesh_back_u = [-2.116, 0, 2.116];
y_mesh_back_u = [4.39, 4.39, 4.39];
z_mesh_back_u = [1.36, 1.36, 1.36];

x_mesh_back_r = [2, 1.569, 1.137, 0.7059];
y_mesh_back_r = [4.15, 3.35, 2.55, 1.75];
z_mesh_back_r = [0, 0, 0, 0];

x_mesh_back_b = [0.5294, 0.3529, 0.1765, 0, -0.1765, -0.3529, -0.5294, -0.7059];
y_mesh_back_b = [1.75, 1.75, 1.75, 1.75, 1.75, 1.75, 1.75, 1.75, 1.75];
z_mesh_back_b = [0, 0, 0, 0, 0, 0, 0, 0, 0];

x_mesh_back_l = [-1.137, -1.569, -2];
y_mesh_back_l = [2.55, 3.35, 4.15];
z_mesh_back_l = [0, 0, 0];
...
x_mid = [-1.5, -1, -0.5, 0, 0.5, 1, 1.5, 0, 0];
y_mid = [4.15, 4.15, 4.15, 4.15, 4.15, 4.15, 4.15, 3.35, 2.55];
