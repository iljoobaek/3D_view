x_mesh_back_u = (-1) * [-2.631, -2.631, -2.631];
y_mesh_back_u = (-1) * [-2.606, -0.03066, 2.606];
z_mesh_back_u = [0.9659, 0.9659, 0.9659];

x_mesh_back_r = [2.52, 1.936, 1.352, 0.72];
y_mesh_back_r = (-1) * [2.496, 2.254, 2.012, 1.75];
z_mesh_back_r = [0, 0, 0, 0];

x_mesh_back_b = (-1) * [-0.72, -0.72, -0.72, -0.72, -0.72, -0.72];
y_mesh_back_b = (-1) * [1.474, 0.5971, -0.02059, -0.5971, -1.474, -1.75];
z_mesh_back_b = [0, 0, 0, 0, 0, 0];

x_mesh_back_l = (-1) * [-1.352, -1.936, -2.52];
...
x_mid = (-1) * [-2.52, -2.52, -2.52, -2.52, -2.52, -1.936, -1.352];
y_mid = (-1) * [-1.674, -0.8516, -0.02936, 0.8516, 1.674, -0.02652, -0.02367];
z_mid = [0, 0, 0, 0, 0, 0, 0];
...
x_bar_back = zeros(4730, 1);
y_bar_back = zeros(4730, 1);
