x_mesh_back_u = (-1) * [-2.631, -2.631, -0.06417, 2.631, 2.631];
y_mesh_back_u = (-1) * [2.606, 4.343, 4.343, 4.343, 2.606];
...
y_mesh_back_l = (-1) * [2.012, 2.254, 2.496];
z_mesh_back_l = [0, 0, 0];
...
x_mid = (-1) * [-2.52, -1.905, -1.291, -0.6761, -0.06146, 0.6761, 1.291, 1.905, 2.52, -0.04723, -0.03299];
y_mid = (-1) * [4.16, 4.16, 4.16, 4.16, 4.16, 4.16, 4.16, 4.16, 4.16, 3.378, 2.597];
...
x_bar_back = zeros(5340, 1);
y_bar_back = zeros(5340, 1);
