...
y_mesh_back_u = [-2.606, -0.03066, 2.606];
...
x_mesh_back_b = [-0.72, -0.72, -0.72, -0.72, -0.72, -0.72];
y_mesh_back_b = [1.474, 0.5971, -0.02059, -0.5971, -1.474, -1.75];
...
x_mid = [-2.52, -2.52, -2.52, -2.52, -2.52, -1.936, -1.352];
y_mid = [-1.674, -0.8516, -0.02936, 0.8516, 1.674, -0.02652, -0.02367];
z_mid = [0, 0, 0, 0, 0, 0, 0];
