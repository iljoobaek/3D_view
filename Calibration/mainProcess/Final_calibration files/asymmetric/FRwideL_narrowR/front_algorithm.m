x_mesh_back_u = [-2.631, -2.631, -0.06417, 2.151];
y_mesh_back_u = [2.606, 4.343, 4.343, 4.343];
...
x_mid = [-2.52, -1.905, -1.291, -0.6761, -0.06146, 0.51, 1.01, 1.53, -0.04723, -0.03299];
y_mid = [4.16, 4.16, 4.16, 4.16, 4.16, 4.16, 4.16, 4.16, 3.378, 2.597];
...
x_bar_back = zeros(2602, 1);
y_bar_back = zeros(2602, 1);
